...
export interface DemoGrid {
  ...
  rows: { id: string; cells: { value: string | number; label?: string }[] }[];
}

export class DemoService {
  static get data(): DemoData {
    const key = localStorage.getItem('cds-data-theme');
    const data: DemoData = deepClone((demoData as any)[key !== 'undefined' ? key : 'infrastructure']);
...
export const infrastructure: DemoData = {
  grid: {
    ...
    rows: [
      ...
      {
        id: 'vm-host-002',
        cells: [{ value: 'vm-host-003' }, { value: 'online' }, { value: 'Europe' }, { value: 20 }, { value: 30 }],
      },
      {
        id: 'vm-host-011',
        cells: [{ value: 'vm-host-003' }, { value: 'online' }, { value: 'Asia Pacific' }, { value: 5 }, { value: 15 }],
      },
      {
        id: 'vm-host-004',
        cells: [
...
export const food: DemoData = {
  grid: {
    ...
    rows: [
      { id: '', cells: [{ value: 'Bakmi' }, { value: 'Indonesia' }, { value: 'Wheat' }, { value: 360 }, { value: 8 }] },
      { id: '', cells: [{ value: 'Chūka men' }, { value: 'Japan' }, { value: 'Wheat' }, { value: 369 }, { value: 9 }] },
      {
        id: '',
        cells: [{ value: 'Kesme' }, { value: 'Central Asia' }, { value: 'Wheat' }, { value: 180 }, { value: 7 }],
      },
      { id: '', cells: [{ value: 'Kalguksu' }, { value: 'Korea' }, { value: 'Wheat' }, { value: 395 }, { value: 7 }] },
      { id: '', cells: [{ value: 'Lamian' }, { value: 'China' }, { value: 'Wheat' }, { value: 350 }, { value: 9 }] },
      {
        id: '',
        cells: [{ value: 'Mee pok' }, { value: 'Southeast Asia' }, { value: 'Wheat' }, { value: 383 }, { value: 8 }],
      },
      { id: '', cells: [{ value: 'Pasta' }, { value: 'Italy' }, { value: 'Wheat' }, { value: 212 }, { value: 9 }] },
      {
        id: '',
        cells: [{ value: 'Reshte' }, { value: 'Central Asia' }, { value: 'Wheat' }, { value: 389 }, { value: 8 }],
      },
      { id: '', cells: [{ value: 'Sōmen' }, { value: 'Japan' }, { value: 'Wheat' }, { value: 203 }, { value: 8 }] },
      { id: '', cells: [{ value: 'Thukpa' }, { value: 'Tibet' }, { value: 'Wheat' }, { value: 439 }, { value: 9 }] },
      { id: '', cells: [{ value: 'Udon' }, { value: 'Japan' }, { value: 'Wheat' }, { value: 190 }, { value: 8 }] },
      { id: '', cells: [{ value: 'Kishimen' }, { value: 'Japan' }, { value: 'Wheat' }, { value: 190 }, { value: 7 }] },
      { id: '', cells: [{ value: 'Bánh phở' }, { value: 'Vietnam' }, { value: 'Rice' }, { value: 141 }, { value: 7 }] },
      {
        id: '',
      ...
      { id: '', cells: [{ value: 'Sevai' }, { value: 'India' }, { value: 'Rice' }, { value: 221 }, { value: 8 }] },
      { id: '', cells: [{ value: 'Idiyappam' }, { value: 'India' }, { value: 'Rice' }, { value: 130 }, { value: 6 }] },
      { id: '', cells: [{ value: 'Mixian' }, { value: 'China' }, { value: 'Rice' }, { value: 117 }, { value: 7 }] },
      {
        id: '',
        cells: [{ value: 'Khanom chin' }, { value: 'Thailand' }, { value: 'Rice' }, { value: 220 }, { value: 8 }],
      },
      { id: '', cells: [{ value: 'Makguksu' }, { value: 'Korea' }, { value: 'Buckwheat' }, { value: 198 }] },
      {
        id: '',
        cells: [{ value: 'Naengmyeon' }, { value: 'Korea' }, { value: 'Buckwheat' }, { value: 500 }, { value: 9 }],
      },
      { id: '', cells: [{ value: 'Soba' }, { value: 'Japan' }, { value: 'Buckwheat' }, { value: 113 }, { value: 7 }] },
      {
        id: '',
        cells: [{ value: 'Pizzoccheri' }, { value: 'Italy' }, { value: 'Buckwheat' }, { value: 342 }, { value: 8 }],
      },
      { id: '', cells: [{ value: 'Youmian' }, { value: 'China' }, { value: 'Egg' }, { value: 475 }] },
      {
        id: '',
        cells: [{ value: 'Lochshen' }, { value: 'Eastern Europe' }, { value: 'Egg' }, { value: 330 }, { value: 8 }],
      },
      { id: '', cells: [{ value: 'Kesme' }, { value: 'Turkey' }, { value: 'Egg' }, { value: 172 }, { value: 9 }] },
      { id: '', cells: [{ value: 'Spätzle' }, { value: 'Germany' }, { value: 'Egg' }, { value: 206 }, { value: 8 }] },
      { id: '', cells: [{ value: 'Acorn' }, { value: 'Korea' }, { value: 'Acorn' }, { value: 390 }, { value: 9 }] },
      {
        id: '',
      ...
      { id: '', cells: [{ value: 'Shirataki' }, { value: 'Japan' }, { value: 'Konjac' }, { value: 20 }, { value: 7 }] },
      { id: '', cells: [{ value: 'Kelp' }, { value: 'Japan' }, { value: 'Seaweed' }, { value: 6 }, { value: 8 }] },
      { id: '', cells: [{ value: 'Spaghetti' }, { value: 'Italy' }, { value: 'Wheat' }, { value: 212 }, { value: 7 }] },
      { id: '', cells: [{ value: 'Linguine' }, { value: 'Italy' }, { value: 'Wheat' }, { value: 212 }, { value: 7 }] },
      { id: '', cells: [{ value: 'Fettucini' }, { value: 'Italy' }, { value: 'Wheat' }, { value: 212 }, { value: 6 }] },
      { id: '', cells: [{ value: 'Lasagne' }, { value: 'Italy' }, { value: 'Wheat' }, { value: 212 }, { value: 7 }] },
      { id: '', cells: [{ value: 'Farfalle' }, { value: 'Italy' }, { value: 'Wheat' }, { value: 212 }, { value: 8 }] },
    ],
  },
};
