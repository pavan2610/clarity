...
The `height` property and `--body-height` CSS Property allows control of the scroll
height of the grid. By default, the grid will expand to the number of provided rows.
